...
# https://www.remax.com/real-estate-agents/chance-toon-shelbyville-tn/102183855
def construct_url(result):
    ...
    city = result['city']
    state = result['state']
    return f"https://www.remax.com/real-estate-agents/{firstName}-{lastName}-{city}-{state}/{masterCard}".lower()


print(construct_url(result))